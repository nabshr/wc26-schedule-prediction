  ...
  return (
    <div className="space-y-6 animate-fade-in">
        ...
        <GlassPanel>
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              ...
              <p className="text-xs text-slate-500">Poll fixtures every 5 mins</p>
            </div>
          </div>
      ...
      <RoundedCard hover={false}>
        <SectionHeader title="API Quota & Polling Mode" subtitle="Adaptive polling: 30 sec live / 5 mins idle" icon={<Gauge className="w-5 h-5" />} />
        <div className="mt-4 space-y-4">
          ...
          <div className="grid grid-cols-3 gap-3">
            ...
            <div className={`p-3 rounded-xl text-center ${
              ...
              <p className={`text-[10px] mt-0.5 ${pollingMode === 'idle' ? 'text-emerald-500' : 'text-slate-400'}`}>Fixtures every 5 mins</p>
            </div>
          </div>

          <p className="text-[10px] text-slate-400 leading-relaxed">
            Fixture sync runs every 5 mins during idle periods. Live sync runs every 30 sec only when a match is live or due to kick off within the next 60 minutes.
